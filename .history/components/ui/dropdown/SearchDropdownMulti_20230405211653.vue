    ...
    <a href="#" class="dropdown-btn justify-content-between d-flex align-items-center" @click.prevent="toggleDropdown">
      ...
      <span v-if="selectedItems.length">
        ...
        <span class="selected-items">
          ...
          <span :key="selectedItem" @click="removeSelectedItem(i)" class="selected-item" v-for="(selectedItem, i) in selectedItems">
          ...
          <template v-else>
            ...
            <span :key="selectedItem" @click="removeSelectedItem(i)" class="selected-item"
