<template>
  <div>
    <ul class="pagination">
      <li class="pagination-prev-nav">
        <a
          href="#"
          @click.prevent="prevPage"
          :class="{ disabled: currentPageProp === 1 }"
        >
          <i class="ri-arrow-left-s-line tx-16"></i>
        </a>
      </li>
      <li
        class="pagination-page-nav"
      ...
      <li class="pagination-next-nav">
        <a
          href="#"
          @click.prevent="nextPage"
          :class="{ disabled: currentPageProp === totalPagesProp }"
        >
          <i class="ri-arrow-right-s-line tx-16"></i>
        </a>
      </li>
    </ul>
  </div>
