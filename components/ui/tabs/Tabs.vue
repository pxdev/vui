    ...
    <ul ref="nav" class="tabbed-nav">
      ...
      >
        <a
          ...
          href="#"
          class="nav-link"
          @click.prevent="onItemClick(i, $event)"
        >
          <i :class="item.icon"></i>
      ...
      <li
        v-if="variant === 'horizontal' || variant === 'horizontal reverse'"
        class="tabs-line"
        :style="`top:${linePosition}px; height: ${lineHeight}px`"
      ></li>
      <li
        v-else
        class="tabs-line"
        :style="`left:${linePosition}px; width: ${lineWidth}px`"
      ></li>
    </ul>
    <slot></slot>
  </nav>
  ...
  methods: {
    onItemClick(index, e) {
      ...
      if (
        ...
        this.variant === 'horizontal reverse'
      ) {
