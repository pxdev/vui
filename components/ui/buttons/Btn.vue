<template>
  ...
  >
    <span class="btn-loading gap-5" v-if="loading"
      ><i class="ri-loader-5-line spin tx-20"></i
    ></span>
    ...
    <span
      ...
      :style="`left: ${rippleLeft}px; top: ${rippleTop}px; width: ${rippleWidth}px; height: ${rippleWidth}px; margin-left: -${
        rippleWidth / 2
      }px; margin-top: -${rippleWidth / 2}px  `"
    ></span>
  </button>
</template>
